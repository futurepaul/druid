...
use druid::widget::{Checkbox, Column, EventForwarder, KeyListener, Label, Padding, Row, Slider, TextBox, ProgressBar};
...
fn main() {
    ...
    let panel = column.ui(&[text_box1_padded, row_1, row_2, row_3], &mut state);
