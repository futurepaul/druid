...
use crate::piet::{
    Color, FillRule, FontBuilder, Gradient, GradientStop, LinearGradient, Text, TextLayout,
    TextLayoutBuilder,
};
...
impl<T: Data> Widget<T> for Button<T> {
    fn paint(&mut self, paint_ctx: &mut PaintCtx, base_state: &BaseState, data: &T, env: &Env) {
        ...
        let border_color = if is_hot { BORDER_LIGHT } else { BORDER };
        ...
        paint_ctx
            .render_ctx
            .fill(rounded_rect, &bg_gradient, FillRule::NonZero);
